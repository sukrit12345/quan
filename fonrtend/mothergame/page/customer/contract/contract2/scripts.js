...
document.getElementById('fileInput3').addEventListener('change', function(event) {
    ...
    const uploadContainer = document.getElementById('uploadContainer3'); 
...
// คลิกที่ภาพเพื่อเลือกไฟล์ใหม่
document.getElementById('previewImage3').addEventListener('click', function() {
