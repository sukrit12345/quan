...
router.get("/detailcontract6/:contract_id", async (req, res) => {
  try {
...
// แสดงการชำระ
router.get('/detailpayments/:contract_id', async (req, res) => {
  // ดึง contract_id จาก path parameter
  ...
  try {
    ...
    ).sort({ createdAt: -1 });        // เรียงรายการใหม่‑สุดก่อน
